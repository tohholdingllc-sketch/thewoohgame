...
const it = {
  ...
  nickBadWord: "Scegli un nickname diverso 🙂",
  deleteAccount: "Elimina account",
  deleteAccountConfirm: "Vuoi eliminare il tuo account? L'operazione è definitiva e cancella i tuoi dati di gioco.",
  deleteAccountErr: "Eliminazione non riuscita. Riprova.",
  disclaimer:
...
const en: typeof it = {
  ...
  nickBadWord: "Please choose a different nickname 🙂",
  deleteAccount: "Delete account",
  deleteAccountConfirm: "Delete your account? This is permanent and erases your game data.",
  deleteAccountErr: "Couldn't delete the account. Try again.",
  disclaimer:
